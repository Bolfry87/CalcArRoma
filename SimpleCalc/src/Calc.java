...
class Roman {
    static String[] romanArray = new String[]{"0", "I", "II", "III", "IV", "V", "VI", "VII", "VIII",
            "IX", "X", "XI", "XII", "XIII", "XIV", "XV", "XVI","XVII", "XVIII", "XIX", "XX","XXI", "XXII,",
             "XXIII","XXIV", "XXV", "XXVI", "XXVII", "XXVII" , "XXIX", "XXX", "XXXI", "XXXII", "XXXIII", "XXXIV",
            ...
            "XCVIII", "XCIX", "C"}; // ужасное решение, но к сожалению с мапами еще не ознакомился, обязательно переделаю :)
